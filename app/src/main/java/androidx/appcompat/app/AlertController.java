...
class AlertController {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (view != null || view2 != null) {
                if (this.mMessage != null) {
                    this.mScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener(this, view, view2){
                        final AlertController this$0;
                    ...
                    this.mScrollView.post(new Runnable(this, view, view2){
                        final AlertController this$0;
                        final View val$bottom;
                        final View val$top;
                        {
                    ...
                    if (view3 != null) {
                        view3.setOnScrollListener(new AbsListView.OnScrollListener(this, view, view2){
                            final AlertController this$0;
                            final View val$bottom;
                            final View val$top;
                            {
                        ...
                        this.mListView.post(new Runnable(this, view, view2){
                            final AlertController this$0;
                            final View val$bottom;
                            final View val$top;
                            {
    ...
    public static class AlertParams {
            ...
            if (this.mIsMultiChoice) {
                object = this.mCursor == null ? new ArrayAdapter<CharSequence>(this, this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems, recycleListView){
                    ...
                    final RecycleListView val$listView;
                    {
                        ...
                        this.mLabelIndex = context.getColumnIndexOrThrow(alertParams.mLabelColumn);
                        this.mIsCheckedIndex = context.getColumnIndexOrThrow(alertParams.mIsCheckedColumn);
                    }
        ...
        public void apply(AlertController alertController) {
            ...
            if ((object = this.mPositiveButtonText) != null || this.mPositiveButtonIcon != null) {
                alertController.setButton(-1, (CharSequence)object, this.mPositiveButtonListener, null, this.mPositiveButtonIcon);
            }
            if ((object = this.mNegativeButtonText) != null || this.mNegativeButtonIcon != null) {
                alertController.setButton(-2, (CharSequence)object, this.mNegativeButtonListener, null, this.mNegativeButtonIcon);
            }
            if ((object = this.mNeutralButtonText) != null || this.mNeutralButtonIcon != null) {
                alertController.setButton(-3, (CharSequence)object, this.mNeutralButtonListener, null, this.mNeutralButtonIcon);
            }
