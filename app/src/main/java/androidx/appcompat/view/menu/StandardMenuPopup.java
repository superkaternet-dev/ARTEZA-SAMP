...
View.OnKeyListener {
    ...
    public StandardMenuPopup(Context context, MenuBuilder menuBuilder, View view, int n, int n2, boolean bl) {
        ...
        this.mAdapter = new MenuAdapter(menuBuilder, LayoutInflater.from((Context)context), bl, ITEM_LAYOUT);
        this.mPopupStyleAttr = n;
        this.mPopupStyleRes = n2;
        Resources resources = context.getResources();
        this.mPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(R.dimen.abc_config_prefDialogWidth));
        this.mAnchorView = view;
        this.mPopup = new MenuPopupWindow(context, null, n, n2);
    ...
    private boolean tryShow() {
        ...
        if (!this.mWasDismissed && (view = this.mAnchorView) != null) {
            ...
            this.mPopup.show();
            view2 = this.mPopup.getListView();
            view2.setOnKeyListener((View.OnKeyListener)this);
            if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
                FrameLayout frameLayout = (FrameLayout)LayoutInflater.from((Context)this.mContext).inflate(R.layout.abc_popup_menu_header_item_layout, (ViewGroup)view2, false);
                view = (TextView)frameLayout.findViewById(16908310);
                if (view != null) {
                    view.setText(this.mMenu.getHeaderTitle());
                }
                frameLayout.setEnabled(false);
                view2.addHeaderView((View)frameLayout, null, false);
            }
