        ...
        if (n6 == Integer.MIN_VALUE) {
            ...
            if (typedValue != null) {
                ...
                if (typedValue.type != 0) {
                    ...
                    n9 = n;
                    if (n3 > 0) {
                        n8 = this.mDecorPadding.left;
                        n9 = this.mDecorPadding.right;
                        n = View.MeasureSpec.getSize((int)n);
                        n9 = View.MeasureSpec.makeMeasureSpec((int)Math.min(n3 - (n8 + n9), n), (int)0x40000000);
                        n8 = 1;
                    }
                }
            }
        ...
        if (n7 == Integer.MIN_VALUE) {
            ...
            if (typedValue != null) {
                ...
                if (typedValue.type != 0) {
                    ...
                    n3 = n2;
                    if (n > 0) {
                        n3 = this.mDecorPadding.top;
                        n4 = this.mDecorPadding.bottom;
                        n2 = View.MeasureSpec.getSize((int)n2);
                        n3 = View.MeasureSpec.makeMeasureSpec((int)Math.min(n - (n3 + n4), n2), (int)0x40000000);
                    }
                }
            }
        }
