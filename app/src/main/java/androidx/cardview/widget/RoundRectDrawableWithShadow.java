...
extends Drawable {
    ...
    private void buildShadowCorners() {
        ...
        rectF2.setShader((Shader)new RadialGradient(0.0f, 0.0f, f + f3, new int[]{n, n, n2}, new float[]{0.0f, f2, 1.0f}, (Shader.TileMode)rectF));
        ...
        rectF.setShader((Shader)new LinearGradient(0.0f, f + f2, 0.0f, f3 - f2, new int[]{n2, n2, n}, new float[]{0.0f, 0.5f, 1.0f}, (Shader.TileMode)rectF2));
