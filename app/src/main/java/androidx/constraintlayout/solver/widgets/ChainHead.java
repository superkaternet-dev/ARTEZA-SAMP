                ...
                block29: {
                    block30: {
                        ...
                        if (((ConstraintWidget)object).getVisibility() != 8) {
                            ...
                            this.mTotalSize = n2 = this.mTotalSize + ((ConstraintWidget)object).mListAnchors[n].getMargin();
                            this.mTotalSize = n2 + ((ConstraintWidget)object).mListAnchors[n + 1].getMargin();
                            this.mTotalMargins = n2 = this.mTotalMargins + ((ConstraintWidget)object).mListAnchors[n].getMargin();
                            this.mTotalMargins = n2 + ((ConstraintWidget)object).mListAnchors[n + 1].getMargin();
                            ...
                            if (((ConstraintWidget)object).mListDimensionBehaviors[this.mOrientation] == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                                if (((ConstraintWidget)object).mResolvedMatchConstraintDefault[this.mOrientation] == 0 || ((ConstraintWidget)object).mResolvedMatchConstraintDefault[this.mOrientation] == 3 || ((ConstraintWidget)object).mResolvedMatchConstraintDefault[this.mOrientation] == 2) {
                                    ...
                                    if ((object2 = this.mLastMatchConstraintWidget) != null) {
                                        ((ConstraintWidget)object2).mListNextMatchConstraintsWidget[this.mOrientation] = object;
                                    }
