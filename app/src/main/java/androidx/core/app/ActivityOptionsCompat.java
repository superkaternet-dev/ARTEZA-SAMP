        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            if (pairArray != null) {
                ...
                while (true) {
                    ...
                    pairArray3[n] = Pair.create(pairArray[n].first, pairArray[n].second);
                    ++n;
                }
            }
            return new ActivityOptionsCompatImpl(ActivityOptions.makeSceneTransitionAnimation((Activity)activity, pairArray2));
        }
        return new ActivityOptionsCompat();
    }
