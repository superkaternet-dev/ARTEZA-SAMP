...
extends Service {
    ...
    static WorkEnqueuer getWorkEnqueuer(Context object, ComponentName componentName, boolean bl, int n) {
        ...
        WorkEnqueuer workEnqueuer2 = workEnqueuer = hashMap.get(var1_4);
        ...
        hashMap.put((ComponentName)var1_4, (WorkEnqueuer)var0_3);
        return var0_3;
    }
    ...
    implements CompatJobEngine {
        ...
        public GenericWorkItem dequeueWork() {
            ...
            jobParameters.getIntent().setExtrasClassLoader(this.mService.getClassLoader());
            return new WrapperWorkItem(this, (JobWorkItem)jobParameters);
        }
