...
public final class ColorUtils {
    ...
    public static void RGBToHSL(int n, int n2, int n3, float[] fArray) {
        ...
        f6 = f = 60.0f * f6 % 360.0f;
        if (f < 0.0f) {
            f6 = f + 360.0f;
        }
        fArray[0] = ColorUtils.constrain(f6, 0.0f, 360.0f);
        fArray[1] = ColorUtils.constrain(f3, 0.0f, 1.0f);
    ...
    public static Color compositeColors(Color object, Color color2) {
        if (ColorUtils$$ExternalSyntheticBackport0.m(object.getModel(), color2.getModel())) {
            if (!ColorUtils$$ExternalSyntheticBackport0.m(color2.getColorSpace(), object.getColorSpace())) {
                object = object.convert(color2.getColorSpace());
            }
            float[] fArray = object.getComponents();
            float[] fArray2 = color2.getComponents();
            ...
            return Color.valueOf((float[])fArray2, (ColorSpace)color2.getColorSpace());
        }
        StringBuilder stringBuilder = new StringBuilder();
    ...
    private static double[] getTempDouble3Array() {
        ...
        double[] dArray2 = dArray = threadLocal.get();
        if (dArray == null) {
