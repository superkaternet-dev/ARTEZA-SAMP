...
public final class DrawableCompat {
    ...
    public static void clearColorFilter(Drawable drawable2) {
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            } else if (drawable2 instanceof DrawableContainer && (drawableContainerState = (DrawableContainer.DrawableContainerState)(drawable2 = (DrawableContainer)drawable2).getConstantState()) != null) {
                int n = drawableContainerState.getChildCount();
                for (int i = 0; i < n; ++i) {
                    drawable2 = drawableContainerState.getChild(i);
