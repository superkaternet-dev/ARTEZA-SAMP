...
public class ViewModelProvider {
    ...
    public <T extends ViewModel> T get(String object, Class<T> clazz) {
        ...
        clazz = object2 instanceof KeyedFactory ? ((KeyedFactory)object2).create((String)object, clazz) : object2.create(clazz);
        this.mViewModelStore.put((String)object, (ViewModel)((Object)clazz));
        return (T)clazz;
    }
