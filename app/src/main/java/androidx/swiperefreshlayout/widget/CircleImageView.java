...
extends ImageView {
    ...
    extends OvalShape {
        ...
        OvalShadow(CircleImageView circleImageView, int n) {
        ...
        private void updateRadialGradient(int n) {
            ...
            tileMode = new RadialGradient(f, f2, f3, new int[]{0x3D000000, 0}, null, tileMode);
        ...
        public void draw(Canvas canvas, Paint paint) {
            ...
            canvas.drawCircle((float)(n / 2), (float)(n2 / 2), (float)(n / 2 - this.this$0.mShadowRadius), paint);
        }
