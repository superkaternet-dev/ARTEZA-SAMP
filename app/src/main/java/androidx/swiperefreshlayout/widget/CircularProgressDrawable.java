...
implements Animatable {
    ...
    private static class Ring {
        ...
        void draw(Canvas canvas, Rect rect) {
            ...
            f2 = f <= 0.0f ? (float)Math.min(rect.width(), rect.height()) / 2.0f - Math.max((float)this.mArrowWidth * this.mArrowScale / 2.0f, this.mStrokeWidth / 2.0f) : (f2 += f);
