        ...
        if (n3 > 0) {
            ...
            if (n > 0) {
                ...
                if (HAS_PICTURE_BITMAP) {
                    viewGroup2 = new Picture();
                    rectF = viewGroup2.beginRecording(n3, n);
                    rectF.concat(matrix);
                    view.draw((Canvas)rectF);
                    viewGroup2.endRecording();
                    viewGroup2 = Bitmap.createBitmap((Picture)viewGroup2);
                } else {
    ...
    implements TypeEvaluator<Matrix> {
        ...
        public Matrix evaluate(float f, Matrix object, Matrix object2) {
            ...
            for (int i = 0; i < 9; ++i) {
                ...
                Matrix matrix = object[i];
                object2 = this.mTempStartValues;
                Matrix matrix2 = object2[i];
                object[i] = object2[i] + f * (matrix - matrix2);
            }
