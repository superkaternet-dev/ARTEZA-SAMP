...
extends ViewGroup {
    ...
    public void draw(Canvas canvas) {
        ...
        if (n3 != 0 && (n3 != 1 || (pagerAdapter = this.mAdapter) == null || pagerAdapter.getCount() <= 1)) {
            ...
            if (!this.mRightEdge.isFinished()) {
                ...
                this.mRightEdge.setSize(n5 - n - n6, n4);
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener((View)this, new OnApplyWindowInsetsListener(this){
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                if ((windowInsetsCompat = ViewCompat.onApplyWindowInsets(view, windowInsetsCompat)).isConsumed()) {
                    return windowInsetsCompat;
                }
                view = this.mTempRect;
                view.left = windowInsetsCompat.getSystemWindowInsetLeft();
                view.top = windowInsetsCompat.getSystemWindowInsetTop();
                view.right = windowInsetsCompat.getSystemWindowInsetRight();
                view.bottom = windowInsetsCompat.getSystemWindowInsetBottom();
                int n = this.this$0.getChildCount();
                for (int i = 0; i < n; ++i) {
                    WindowInsetsCompat windowInsetsCompat2 = ViewCompat.dispatchApplyWindowInsets(this.this$0.getChildAt(i), windowInsetsCompat);
                    view.left = Math.min(windowInsetsCompat2.getSystemWindowInsetLeft(), view.left);
                    view.top = Math.min(windowInsetsCompat2.getSystemWindowInsetTop(), view.top);
                    view.right = Math.min(windowInsetsCompat2.getSystemWindowInsetRight(), view.right);
                    view.bottom = Math.min(windowInsetsCompat2.getSystemWindowInsetBottom(), view.bottom);
                }
                return windowInsetsCompat.replaceSystemWindowInsets(view.left, view.top, view.right, view.bottom);
            }
        });
    }
    ...
    protected void onLayout(boolean bl, int n, int n2, int n3, int n4) {
            ...
            if (object2.getVisibility() != 8) {
                ...
                if (object.isDecor) {
                    ...
                    switch (n3 & 7) {
                        ...
                        case 5: {
                            n3 = n9 - n11 - object2.getMeasuredWidth();
                        ...
                        case 3: {
                            n3 = n;
                            n6 = n + object2.getMeasuredWidth();
                            break;
                        }
                        case 1: {
                            n3 = Math.max((n9 - object2.getMeasuredWidth()) / 2, n);
                            n6 = n;
                        }
                    }
                    switch (n5 & 0x70) {
                        ...
                        case 80: {
                            n = n10 - n4 - object2.getMeasuredHeight();
                            n4 += object2.getMeasuredHeight();
                            break;
                        }
                        case 48: {
                            n = n2;
                            n2 += object2.getMeasuredHeight();
                            break;
                        }
                        case 16: {
                            n = Math.max((n10 - object2.getMeasuredHeight()) / 2, n2);
                        }
                    }
                    object2.layout(n3 += n12, n, n3 + object2.getMeasuredWidth(), n + object2.getMeasuredHeight());
                    n15 = n13 + 1;
                    n3 = n6;
                    n6 = n2;
                    n5 = n11;
        ...
        for (n11 = 0; n11 < n6; ++n11) {
            ...
            if (layoutParams.isDecor || (object2 = this.infoForChild((View)object)) == null) continue;
            n5 = n + (int)((float)n7 * object2.offset);
            if (layoutParams.needsMeasure) {
                layoutParams.needsMeasure = false;
                object.measure(View.MeasureSpec.makeMeasureSpec((int)((int)((float)n7 * layoutParams.widthFactor)), (int)0x40000000), View.MeasureSpec.makeMeasureSpec((int)(n10 - n2 - n4), (int)0x40000000));
            }
            object.layout(n5, n2, object.getMeasuredWidth() + n5, object.getMeasuredHeight() + n2);
        }
        ...
        if (object != null && ((PagerAdapter)object).getCount() != 0) {
            ...
            switch (n & 0xFF) {
                ...
                case 1: {
                    ...
                    object = this.infoForCurrentScrollPosition();
                    float f = (float)this.mPageMargin / (float)n2;
                    this.setCurrentItemInternal(this.determineTargetPage(((ItemInfo)object).position, ((float)n3 / (float)n2 - ((ItemInfo)object).offset) / (((ItemInfo)object).widthFactor + f), n, (int)(motionEvent.getX(motionEvent.findPointerIndex(this.mActivePointerId)) - this.mInitialMotionX)), true, true, n);
                    bl = this.resetTouch();
                    break;
                }
                case 0: {
        ...
        if (n5 == this.mExpectedAdapterCount) {
            ...
            if (itemInfo != null) {
                ...
                for (n7 = this.mCurItem - 1; n7 >= 0; --n7) {
                    if (f2 >= f3 && n7 < n4) {
                        ...
                        if (n7 == itemInfo2.position) {
                            ...
                            if (!itemInfo2.scrolling) {
                                ...
                                this.mAdapter.destroyItem(this, n7, itemInfo2.object);
                                n2 = n8 - 1;
                                n = n10 - 1;
                    ...
                    } else if (itemInfo2 != null && n7 == itemInfo2.position) {
