...
implements TextWatcher {
    ...
    public MaskedEditText(Context context, AttributeSet object) {
        ...
        this.mask = context.getString(R.styleable.MaskedEditText_mask);
        this.allowedChars = context.getString(R.styleable.MaskedEditText_allowed_chars);
        this.deniedChars = context.getString(R.styleable.MaskedEditText_denied_chars);
        object = context.getString(R.styleable.MaskedEditText_char_representation);
        this.charRepresentation = object == null ? (char)35 : ((String)object).charAt(0);
        this.keepHint = context.getBoolean(R.styleable.MaskedEditText_keep_hint, false);
        this.cleanUp();
        this.setOnEditorActionListener(new TextView.OnEditorActionListener(this){
    ...
    static /* synthetic */ boolean access$102(MaskedEditText maskedEditText, boolean bl) {
    ...
    private void cleanUp() {
        ...
        super.setOnFocusChangeListener(new View.OnFocusChangeListener(this){
            final MaskedEditText this$0;
            {
                this.this$0 = maskedEditText;
            }
            ...
            public void onFocusChange(View object, boolean bl) {
                ...
                if (this.this$0.hasFocus()) {
                    MaskedEditText.access$102(this.this$0, false);
                    object = this.this$0;
    ...
    private CharSequence makeMaskedTextWithHint() {
        ...
        for (int i = 0; i < this.mask.length(); ++i) {
            int[] nArray;
            int n2 = this.maskToRaw[i];
            if (n2 != -1) {
                if (n2 < this.rawText.length()) {
                    spannableStringBuilder.append(this.rawText.charAt(n2));
                } else {
                    spannableStringBuilder.append(this.getHint().charAt(this.maskToRaw[i]));
                }
            } else {
                spannableStringBuilder.append(this.mask.charAt(i));
            }
            if ((!this.keepHint || (n2 = this.rawText.length()) >= (nArray = this.rawToMask).length || i < nArray[this.rawText.length()]) && (this.keepHint || i < n)) continue;
            spannableStringBuilder.setSpan((Object)new ForegroundColorSpan(this.getCurrentHintTextColor()), i, i + 1, 0);
        }
    ...
    public void onRestoreInstanceState(Parcelable object) {
        Object object2 = (Bundle)object;
        super.onRestoreInstanceState(((Bundle)object).getParcelable("super"));
        object2 = object2.getString("text");
        object = new StringBuilder();
        ((StringBuilder)object).append("onRestoreInstanceState: ");
        ((StringBuilder)object).append((String)object2);
        Log.d((String)"ContentValues", (String)((StringBuilder)object).toString());
    ...
    protected void onSelectionChanged(int n, int n2) {
        ...
        super.onSelectionChanged(n3, n4);
    }
    ...
    public void onTextChanged(CharSequence object, int object2, int n, int n2) {
        if (!this.editingOnChanged && this.editingBefore) {
            ...
            if (n2 > 0) {
                ...
                object = object.subSequence((int)object2, object2 + n2).toString();
                object2 = this.rawText.addToString(this.clear((String)object), n, this.maxRawLength);
                if (this.initialized) {
