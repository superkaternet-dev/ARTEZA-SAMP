...
public class IndeterminateRoundCornerProgressBar
extends RoundCornerProgressBar {
    public IndeterminateRoundCornerProgressBar(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    public IndeterminateRoundCornerProgressBar(Context context, AttributeSet attributeSet, int n) {
        super(context, attributeSet, n);
    }

    public IndeterminateRoundCornerProgressBar(Context context, AttributeSet attributeSet, int n, int n2) {
