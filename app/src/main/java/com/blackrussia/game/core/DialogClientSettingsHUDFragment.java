...
public class DialogClientSettingsHUDFragment
extends Fragment
implements ISaveableFragment {
    ...
    public static DialogClientSettingsHUDFragment createInstance(String string2) {
    ...
    private void setSeekBarListeners() {
        ...
        this.mListenerSeekBars = new SeekBar.OnSeekBarChangeListener(this){
            final DialogClientSettingsHUDFragment this$0;
            {
                this.this$0 = dialogClientSettingsHUDFragment;
            }
            ...
            public void onStartTrackingTouch(SeekBar seekBar) {
                DialogClientSettingsHUDFragment dialogClientSettingsHUDFragment = this.this$0;
                dialogClientSettingsHUDFragment.makeAllElementsInvisible(dialogClientSettingsHUDFragment.mParentView, (View)seekBar, true);
            }

            public void onStopTrackingTouch(SeekBar seekBar) {
                DialogClientSettingsHUDFragment dialogClientSettingsHUDFragment = this.this$0;
                dialogClientSettingsHUDFragment.makeAllElementsVisible(dialogClientSettingsHUDFragment.mParentView, (View)seekBar, true);
        ...
        for (n3 = 0; n3 < 3; ++n3) {
            charSequence2 = new StringBuilder();
            ((StringBuilder)charSequence2).append("custom_widget_pos_x_");
            ((StringBuilder)charSequence2).append(n3);
            charSequence2 = ((StringBuilder)charSequence2).toString();
            charSequence = new StringBuilder();
            ((StringBuilder)charSequence).append("custom_widget_pos_y_");
            ((StringBuilder)charSequence).append(n3);
            charSequence = ((StringBuilder)charSequence).toString();
            CharSequence charSequence3 = new StringBuilder();
            charSequence3.append("custom_widget_size_");
            charSequence3.append(n3);
            charSequence3 = charSequence3.toString();
            int n4 = this.mContext.getResources().getIdentifier((String)charSequence2, "id", this.mContext.getPackageName());
            n2 = this.mContext.getResources().getIdentifier((String)charSequence, "id", this.mContext.getPackageName());
            n = this.mContext.getResources().getIdentifier((String)charSequence3, "id", this.mContext.getPackageName());
            charSequence2 = (SeekBar)this.mRootView.findViewById(n4);
            charSequence3 = (SeekBar)this.mRootView.findViewById(n2);
            charSequence = (SeekBar)this.mRootView.findViewById(n);
            if (charSequence2 != null) {
                charSequence2.setOnSeekBarChangeListener(this.mListenerSeekBars);
            }
            if (charSequence3 != null) {
                charSequence3.setOnSeekBarChangeListener(this.mListenerSeekBars);
            }
            if (charSequence == null) continue;
            charSequence.setOnSeekBarChangeListener(this.mListenerSeekBars);
        }
    ...
    public void getValues() {
        ...
        for (n3 = 0; n3 < 10; ++n3) {
            ...
            if (object != null) {
                object.setProgress((int)object2[0]);
            }
            if (charSequence == null) continue;
            charSequence.setProgress((int)object2[1]);
        }
        for (n3 = 0; n3 < 10; ++n3) {
            object2 = new StringBuilder();
            ...
            charSequence = (SeekBar)this.mRootView.findViewById(n);
            object2 = (SeekBar)this.mRootView.findViewById(n2);
        ...
        for (n3 = 0; n3 < 3; ++n3) {
            object2 = new StringBuilder();
            ((StringBuilder)object2).append("custom_widget_pos_x_");
            ((StringBuilder)object2).append(n3);
            object2 = ((StringBuilder)object2).toString();
            object = new StringBuilder();
            ((StringBuilder)object).append("custom_widget_pos_y_");
            ((StringBuilder)object).append(n3);
            object = ((StringBuilder)object).toString();
            charSequence = new StringBuilder();
            charSequence.append("custom_widget_size_");
            charSequence.append(n3);
            charSequence = charSequence.toString();
            n = this.mContext.getResources().getIdentifier((String)object2, "id", this.mContext.getPackageName());
            int n4 = this.mContext.getResources().getIdentifier((String)object, "id", this.mContext.getPackageName());
            n2 = this.mContext.getResources().getIdentifier((String)charSequence, "id", this.mContext.getPackageName());
            charSequence = (SeekBar)this.mRootView.findViewById(n);
            object2 = (SeekBar)this.mRootView.findViewById(n4);
            SeekBar seekBar = (SeekBar)this.mRootView.findViewById(n2);
            object = this.mContext.getNativeWidgetPositionAndScale(n3);
            this.mContext.setNativeWidgetPositionAndScale(n3, (int)object[0], (int)object[1], (int)object[2]);
            if (object[0] == -1 || object[1] == -1 || object[2] == -1) continue;
            charSequence.setProgress((int)object[0]);
            object2.setProgress((int)object[1]);
            seekBar.setProgress((int)object[2]);
        }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.mRootView = layoutInflater.inflate(2131558460, viewGroup, false);
    ...
    public void passValuesToNative() {
        ...
        for (n3 = 0; n3 < 3; ++n3) {
            ...
            int n4 = this.mContext.getResources().getIdentifier((String)charSequence, "id", this.mContext.getPackageName());
            n2 = this.mContext.getResources().getIdentifier((String)charSequence3, "id", this.mContext.getPackageName());
            charSequence = (SeekBar)this.mRootView.findViewById(n);
            charSequence3 = (SeekBar)this.mRootView.findViewById(n4);
            charSequence2 = (SeekBar)this.mRootView.findViewById(n2);
            this.mContext.setNativeWidgetPositionAndScale(n3, charSequence.getProgress(), charSequence3.getProgress(), charSequence2.getProgress());
        }
    }
