...
implements View.OnClickListener {
    ...
    public /* synthetic */ MainActivity$$ExternalSyntheticLambda2(MainActivity mainActivity, Dialog dialog) {
        this.f$0 = mainActivity;
        this.f$1 = dialog;
    }

    public final void onClick(View view) {
        this.f$0.lambda$onCreate$3$com-blackrussia-launcher-activity-MainActivity(this.f$1, view);
    }
}
