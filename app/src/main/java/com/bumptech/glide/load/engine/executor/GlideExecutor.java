...
implements ExecutorService {
    ...
    public static Builder newAnimationBuilder() {
        ...
        return new Builder(true).setThreadCount(n).setName(DEFAULT_ANIMATION_EXECUTOR_NAME);
    }
    ...
    public static final class Builder {
        ...
        public GlideExecutor build() {
            if (!TextUtils.isEmpty((CharSequence)this.name)) {
                ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(this.corePoolSize, this.maximumPoolSize, this.threadTimeoutMillis, TimeUnit.MILLISECONDS, new PriorityBlockingQueue<Runnable>(), new DefaultThreadFactory(this.threadFactory, this.name, this.uncaughtThrowableStrategy, this.preventNetworkOperations));
    ...
    implements ThreadFactory {
        ...
        public Thread newThread(Runnable runnable) {
            return new Thread(this, runnable){
                ...
                {
                    this.this$0 = defaultPriorityThreadFactory;
                    super(runnable);
                }
    ...
    implements ThreadFactory {
        ...
        DefaultThreadFactory(ThreadFactory threadFactory, String string2, UncaughtThrowableStrategy uncaughtThrowableStrategy, boolean bl) {
        ...
        public Thread newThread(Runnable object) {
            Thread thread2 = this.delegate.newThread(new Runnable(this, (Runnable)object){
            ...
            ((StringBuilder)object).append("glide-");
            ((StringBuilder)object).append(this.name);
            ((StringBuilder)object).append("-thread-");
            ((StringBuilder)object).append(this.threadNum.getAndIncrement());
    ...
    public static interface UncaughtThrowableStrategy {
        ...
        static {
            ...
            LOG = uncaughtThrowableStrategy = new UncaughtThrowableStrategy(){
