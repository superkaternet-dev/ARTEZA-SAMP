...
class GifFrameLoader {
    ...
    private void loadNextFrame() {
        if (this.isRunning && !this.isLoadPending) {
            ...
            ((RequestBuilder)((RequestBuilder)this.requestBuilder.apply((BaseRequestOptions)RequestOptions.signatureOf(GifFrameLoader.getFrameSignature()))).load(this.gifDecoder)).into(this.next);
            return;
        }
    }
    ...
    implements Handler.Callback {
        ...
        public boolean handleMessage(Message object) {
            if (object.what == 1) {
                ...
                this.this$0.onFrameReady((DelayTarget)object);
                return true;
            }
            if (object.what == 2) {
                object = (DelayTarget)object.obj;
                this.this$0.requestManager.clear((Target<?>)object);
            }
            return false;
        }
    }
