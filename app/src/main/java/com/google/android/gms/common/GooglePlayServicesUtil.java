...
extends GooglePlayServicesUtilLight {
    ...
    public static boolean showErrorDialogFragment(int n, Activity activity, Fragment fragment, int n2, DialogInterface.OnCancelListener onCancelListener) {
        ...
        if ((fragment = googleApiAvailability.zaa((Context)activity, n3, zag.zac(fragment, GoogleApiAvailability.getInstance().getErrorResolutionIntent((Context)activity, n3, "d"), n2), onCancelListener)) == null) {
            return false;
        }
