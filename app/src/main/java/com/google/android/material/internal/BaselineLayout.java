...
extends ViewGroup {
    ...
    protected void onMeasure(int n, int n2) {
        ...
        n8 = Math.max(n3, this.getSuggestedMinimumHeight());
        n6 = Math.max(n5, this.getSuggestedMinimumWidth());
        this.setMeasuredDimension(View.resolveSizeAndState((int)n6, (int)n, (int)n9), View.resolveSizeAndState((int)n8, (int)n2, (int)(n9 << 16)));
    }
}
