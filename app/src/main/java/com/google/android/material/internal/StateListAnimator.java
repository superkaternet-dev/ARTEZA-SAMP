...
public final class StateListAnimator {
    ...
    public StateListAnimator() {
        this.animationListener = new AnimatorListenerAdapter(this){
            ...
            public void onAnimationEnd(Animator animator2) {
                if (this.this$0.runningAnimator == animator2) {
    ...
    public void setState(int[] object) {
        ...
        if (tuple == (object = (Object)this.lastMatch)) {
            return;
        }
        if (object != null) {
            this.cancel();
    ...
    static class Tuple {
        ...
        Tuple(int[] nArray, ValueAnimator valueAnimator) {
            this.specs = nArray;
