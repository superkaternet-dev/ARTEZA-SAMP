...
public final class AndroidAppCheckTokenProvider$$ExternalSyntheticLambda4
implements Deferred.DeferredHandler {
    ...
    public final void handle(Provider provider) {
        AndroidAppCheckTokenProvider.lambda$addTokenChangeListener$5(this.f$0, this.f$1, provider);
    }
}
