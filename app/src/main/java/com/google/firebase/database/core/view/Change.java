...
public class Change {
    ...
    public static Change childAddedChange(ChildKey childKey, Node node) {
        return Change.childAddedChange(childKey, IndexedNode.from(node));
    }
    ...
    public static Change childChangedChange(ChildKey childKey, Node node, Node node2) {
        return Change.childChangedChange(childKey, IndexedNode.from(node), IndexedNode.from(node2));
    }
    ...
    public static Change childMovedChange(ChildKey childKey, Node node) {
        return Change.childMovedChange(childKey, IndexedNode.from(node));
    }
    ...
    public static Change childRemovedChange(ChildKey childKey, Node node) {
        return Change.childRemovedChange(childKey, IndexedNode.from(node));
    }
