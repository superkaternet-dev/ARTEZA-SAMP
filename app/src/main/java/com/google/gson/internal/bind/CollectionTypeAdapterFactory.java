...
implements TypeAdapterFactory {
    ...
    extends TypeAdapter<Collection<E>> {
        ...
        @Override
        public void write(JsonWriter jsonWriter, Collection<E> collection2) throws IOException {
            if (collection2 == null) {
                jsonWriter.nullValue();
                return;
            }
            jsonWriter.beginArray();
            for (Collection<E> collection2 : collection2) {
                this.elementTypeAdapter.write(jsonWriter, collection2);
            }
            jsonWriter.endArray();
        }
    }
