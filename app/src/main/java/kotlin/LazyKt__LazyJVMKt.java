...
class LazyKt__LazyJVMKt {
    ...
    public static final <T> Lazy<T> lazy(LazyThreadSafetyMode object, Function0<? extends T> function0) {
        ...
        Intrinsics.checkNotNullParameter(function0, "initializer");
        switch (LazyKt$WhenMappings.$EnumSwitchMapping$0[object.ordinal()]) {
            default: {
                throw new NoWhenBranchMatchedException();
            }
            case 3: {
                object = new UnsafeLazyImpl<T>(function0);
                break;
            }
            case 2: {
                object = new SafePublicationLazyImpl<T>(function0);
                break;
            }
            case 1: {
                object = new SynchronizedLazyImpl(function0, null, 2, null);
            }
        }
        return object;
    }
