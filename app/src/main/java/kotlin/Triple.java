    ...
    public boolean equals(Object object) {
        block2: {
            block3: {
                ...
                if (Intrinsics.areEqual(this.first, ((Triple)object).first) && Intrinsics.areEqual(this.second, ((Triple)object).second) && Intrinsics.areEqual(this.third, ((Triple)object).third)) break block2;
            }
            return false;
        }
        return true;
