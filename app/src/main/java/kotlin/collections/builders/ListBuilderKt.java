...
public final class ListBuilderKt {
    ...
    public static final <E> E[] arrayOfUninitializedElements(int n) {
        ...
        throw (Throwable)new IllegalArgumentException("capacity must be non-negative.".toString());
    }

    public static final <T> T[] copyOfUninitializedElements(T[] TArray, int n) {
        Intrinsics.checkNotNullParameter(TArray, "$this$copyOfUninitializedElements");
    ...
    public static final <E> void resetAt(E[] EArray, int n) {
        Intrinsics.checkNotNullParameter(EArray, "$this$resetAt");
        EArray[n] = null;
    }

    public static final <E> void resetRange(E[] EArray, int n, int n2) {
        Intrinsics.checkNotNullParameter(EArray, "$this$resetRange");
        while (n < n2) {
    ...
    private static final <T> boolean subarrayContentEquals(T[] TArray, int n, int n2, List<?> list) {
        ...
        for (int i = 0; i < n2; ++i) {
            if (!(true ^ Intrinsics.areEqual(TArray[n + i], list.get(i)))) continue;
            return false;
        }
        return true;
    }
    ...
    private static final <T> String subarrayContentToString(T[] object, int n, int n2) {
        ...
        for (int i = 0; i < n2; ++i) {
            ...
            stringBuilder.append(object[n + i]);
        }
        stringBuilder.append("]");
