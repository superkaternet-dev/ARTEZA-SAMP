...
public final class ContinuationKt {
    ...
    public static final <T> void startCoroutine(Function1<? super Continuation<? super T>, ? extends Object> object, Continuation<? super T> continuation) {
        Intrinsics.checkNotNullParameter(object, "$this$startCoroutine");
        Intrinsics.checkNotNullParameter(continuation, "completion");
        continuation = IntrinsicsKt.intercepted(IntrinsicsKt.createCoroutineUnintercepted(object, continuation));
        object = Unit.INSTANCE;
        Result.Companion companion = Result.Companion;
        continuation.resumeWith(Result.constructor-impl(object));
    }

    public static final <R, T> void startCoroutine(Function2<? super R, ? super Continuation<? super T>, ? extends Object> object, R object2, Continuation<? super T> continuation) {
        Intrinsics.checkNotNullParameter(object, "$this$startCoroutine");
        Intrinsics.checkNotNullParameter(continuation, "completion");
        continuation = IntrinsicsKt.intercepted(IntrinsicsKt.createCoroutineUnintercepted(object, object2, continuation));
        object = Unit.INSTANCE;
    ...
    private static final <T> Object suspendCoroutine(Function1<? super Continuation<? super T>, Unit> object, Continuation<? super T> continuation) {
        InlineMarker.mark(0);
        SafeContinuation<T> safeContinuation = new SafeContinuation<T>(IntrinsicsKt.intercepted(continuation));
