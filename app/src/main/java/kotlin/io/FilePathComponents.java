...
public final class FilePathComponents {
    ...
    public boolean equals(Object object) {
        block2: {
            block3: {
                ...
                if (Intrinsics.areEqual(this.root, ((FilePathComponents)object).root) && Intrinsics.areEqual(this.segments, ((FilePathComponents)object).segments)) break block2;
            }
            return false;
        }
        return true;
    ...
    public final String getRootName() {
        ...
        Intrinsics.checkNotNullExpressionValue(string2, "root.path");
        return string2;
    }
