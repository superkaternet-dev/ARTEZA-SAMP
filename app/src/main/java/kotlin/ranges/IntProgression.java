...
KMappedMarker {
    ...
    public boolean equals(Object object) {
        boolean bl = object instanceof IntProgression && (this.isEmpty() && ((IntProgression)object).isEmpty() || this.first == ((IntProgression)object).first && this.last == ((IntProgression)object).last && this.step == ((IntProgression)object).step);
        return bl;
    }
    ...
    public boolean isEmpty() {
        int n = this.step;
        boolean bl = true;
        if (!(n > 0 ? this.first > this.last : this.first < this.last)) {
            bl = false;
        }
        return bl;
    }
