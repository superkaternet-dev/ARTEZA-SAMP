...
implements ClosedRange<Integer> {
    ...
    public boolean equals(Object object) {
        boolean bl = object instanceof IntRange && (this.isEmpty() && ((IntRange)object).isEmpty() || this.getFirst() == ((IntRange)object).getFirst() && this.getLast() == ((IntRange)object).getLast());
        return bl;
    }
