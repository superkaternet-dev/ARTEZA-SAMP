...
implements ClosedRange<Long> {
    ...
    public boolean equals(Object object) {
        boolean bl = object instanceof LongRange && (this.isEmpty() && ((LongRange)object).isEmpty() || this.getFirst() == ((LongRange)object).getFirst() && this.getLast() == ((LongRange)object).getLast());
        return bl;
    }
