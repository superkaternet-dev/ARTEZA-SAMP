...
implements ClosedRange<UInt> {
    ...
    public boolean contains-WZ4Q5Ns(int n) {
        boolean bl = UnsignedKt.uintCompare(this.getFirst-pVg5ArA(), n) <= 0 && UnsignedKt.uintCompare(n, this.getLast-pVg5ArA()) <= 0;
        return bl;
    }

    @Override
    public boolean equals(Object object) {
        boolean bl = object instanceof UIntRange && (this.isEmpty() && ((UIntRange)object).isEmpty() || this.getFirst-pVg5ArA() == ((UIntRange)object).getFirst-pVg5ArA() && this.getLast-pVg5ArA() == ((UIntRange)object).getLast-pVg5ArA());
        return bl;
    }
    ...
    @Override
    public int hashCode() {
        int n = this.isEmpty() ? -1 : this.getFirst-pVg5ArA() * 31 + this.getLast-pVg5ArA();
        return n;
    }

    @Override
    public boolean isEmpty() {
        boolean bl = UnsignedKt.uintCompare(this.getFirst-pVg5ArA(), this.getLast-pVg5ArA()) > 0;
        return bl;
    }
    ...
    public String toString() {
        ...
        stringBuilder.append(UInt.toString-impl(this.getFirst-pVg5ArA()));
        stringBuilder.append("..");
        stringBuilder.append(UInt.toString-impl(this.getLast-pVg5ArA()));
