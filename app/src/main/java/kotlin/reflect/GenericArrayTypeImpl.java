...
TypeImpl {
    ...
    public boolean equals(Object object) {
        boolean bl = object instanceof GenericArrayType && Intrinsics.areEqual(this.getGenericComponentType(), ((GenericArrayType)object).getGenericComponentType());
        return bl;
    }
    ...
    public String getTypeName() {
        ...
        stringBuilder.append(TypesJVMKt.access$typeToString(this.elementType));
