...
TypeImpl {
    ...
    public boolean equals(Object object) {
        boolean bl = object instanceof TypeVariable && Intrinsics.areEqual(this.getName(), ((TypeVariable)object).getName()) && Intrinsics.areEqual(this.getGenericDeclaration(), ((TypeVariable)object).getGenericDeclaration());
        return bl;
    }
    ...
    public Type[] getBounds() {
        ...
        Object object2 = (Type[])new ArrayList(CollectionsKt.collectionSizeOrDefault(object, 10));
        object = object.iterator();
        while (object.hasNext()) {
            object2.add(TypesJVMKt.access$computeJavaType((KType)object.next(), true));
        }
        object2 = (List)object2;
        if ((object2 = object2.toArray(new Type[0])) != null) {
            return object2;
        }
