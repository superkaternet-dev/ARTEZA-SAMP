...
TypeImpl {
    ...
    public boolean equals(Object object) {
        boolean bl = object instanceof WildcardType && Arrays.equals(this.getUpperBounds(), ((WildcardType)object).getUpperBounds()) && Arrays.equals(this.getLowerBounds(), ((WildcardType)object).getLowerBounds());
        return bl;
    }
    ...
    public String getTypeName() {
        ...
        if (this.lowerBound != null) {
            ...
            ((StringBuilder)object).append(TypesJVMKt.access$typeToString(this.lowerBound));
            object = ((StringBuilder)object).toString();
        } else {
            object = this.upperBound;
            if (object != null && Intrinsics.areEqual(object, Object.class) ^ true) {
                object = new StringBuilder();
                ((StringBuilder)object).append("? extends ");
                ((StringBuilder)object).append(TypesJVMKt.access$typeToString(this.upperBound));
                object = ((StringBuilder)object).toString();
            } else {
                object = "?";
            }
