...
public class FileHeader {
    ...
    public void extractFile(ZipModel zipModel, String string2, UnzipParameters unzipParameters, String string3, ProgressMonitor progressMonitor, boolean bl) throws ZipException {
        if (zipModel != null) {
            if (Zip4jUtil.checkOutputFolder(string2)) {
                new Unzip(zipModel).extractFile(this, string2, unzipParameters, string3, progressMonitor, bl);
                return;
            }
    ...
    public void extractFile(ZipModel zipModel, String string2, UnzipParameters unzipParameters, ProgressMonitor progressMonitor, boolean bl) throws ZipException {
        this.extractFile(zipModel, string2, unzipParameters, null, progressMonitor, bl);
    }

    public void extractFile(ZipModel zipModel, String string2, ProgressMonitor progressMonitor, boolean bl) throws ZipException {
        this.extractFile(zipModel, string2, null, progressMonitor, bl);
    }
