...
class OptionalMethod<T> {
    ...
    public OptionalMethod(Class<?> clazz, String string2, Class ... classArray) {
    ...
    private static Method getPublicMethod(Class<?> genericDeclaration, String string2, Class[] classArray) {
        GenericDeclaration genericDeclaration2 = null;
        genericDeclaration2 = genericDeclaration = ((Class)genericDeclaration).getMethod(string2, classArray);
        try {
    ...
    public Object invokeOptional(T object, Object ... objectArray) throws InvocationTargetException {
        Method method = this.getMethod(object.getClass());
        if (method == null) {
            return null;
        }
