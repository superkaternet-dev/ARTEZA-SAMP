...
implements Variant {
    ...
    implements FrameReader {
        ...
        private void readGoAway(FrameReader.Handler handler, int n, int n2) throws IOException {
            if (n2 == 8) {
                ...
                ErrorCode errorCode = ErrorCode.fromSpdyGoAway(n);
                if (errorCode != null) {
                    handler.goAway(n2 & Integer.MAX_VALUE, errorCode, ByteString.EMPTY);
                    return;
                }
                throw Reader.ioException("TYPE_GOAWAY unexpected error code: %d", n);
            }
        ...
        private void readRstStream(FrameReader.Handler handler, int n, int n2) throws IOException {
            if (n2 == 8) {
                n2 = this.source.readInt();
                n = this.source.readInt();
                ErrorCode errorCode = ErrorCode.fromSpdy3Rst(n);
                if (errorCode != null) {
                    handler.rstStream(n2 & Integer.MAX_VALUE, errorCode);
                    return;
                }
                throw Reader.ioException("TYPE_RST_STREAM unexpected error code: %d", n);
            }
            throw Reader.ioException("TYPE_RST_STREAM length: %d != 8", n2);
        }

        private void readSettings(FrameReader.Handler object, int n, int n2) throws IOException {
            ...
            if (n2 == n3 * 8 + 4) {
                ...
                for (n2 = 0; n2 < n3; ++n2) {
                    ...
                    settings.set(0xFFFFFF & n4, (0xFF000000 & n4) >>> 24, this.source.readInt());
                }
                if ((n & 1) != 0) {
                    bl = true;
                }
                object.settings(bl, settings);
                return;
            }
            object = Reader.ioException("TYPE_SETTINGS length: %d != 4 + 8 * %d", n2, n3);
            throw object;
        }
        ...
        public boolean nextFrame(FrameReader.Handler object) throws IOException {
            ...
            block13: {
                ...
                block14: {
                    ...
                    switch (0xFFFF & n3) {
                        ...
                        case 9: {
                            this.readWindowUpdate((FrameReader.Handler)object, n, n2);
                            return true;
                        }
                        case 8: {
                            this.readHeaders((FrameReader.Handler)object, n, n2);
                            return true;
                        }
                        case 7: {
                            this.readGoAway((FrameReader.Handler)object, n, n2);
                            return true;
                        }
                        case 6: {
                            this.readPing((FrameReader.Handler)object, n, n2);
                            return true;
                        }
                        case 4: {
                            this.readSettings((FrameReader.Handler)object, n, n2);
                            return true;
                        }
                        case 3: {
                            this.readRstStream((FrameReader.Handler)object, n, n2);
                            return true;
                        }
                        case 2: {
                            this.readSynReply((FrameReader.Handler)object, n, n2);
                            return true;
                        }
                        case 1: 
                    }
                    this.readSynStream((FrameReader.Handler)object, n, n2);
                    return true;
                }
            ...
            object.data(bl, Integer.MAX_VALUE & n3, this.source, n2);
            return true;
        }
    ...
    implements FrameWriter {
        ...
        Writer(BufferedSink bufferedSink, boolean bl) {
            ...
            this.headerBlockBuffer = bufferedSink;
            this.headerBlockOut = Okio.buffer(new DeflaterSink((Sink)bufferedSink, deflater));
        }
            ...
            synchronized (this) {
                if (!this.closed) {
                    if (object.spdyGoAwayCode != -1) {
                        this.sink.writeInt(0x80030000 | 0xFFFF & 7);
                        this.sink.writeInt((0 & 0xFF) << 24 | 0xFFFFFF & 8);
        ...
        public void headers(int n, List<Header> object) throws IOException {
            synchronized (this) {
                if (!this.closed) {
                    ...
                    this.sink.writeInt(0x80030000 | 0xFFFF & 8);
                    this.sink.writeInt((0 & 0xFF) << 24 | 0xFFFFFF & n2);
        ...
        public void ping(boolean bl, int n, int n2) throws IOException {
            synchronized (this) {
                ...
                if (bl == bl3) {
                    this.sink.writeInt(0x80030000 | 0xFFFF & 6);
                    this.sink.writeInt((0 & 0xFF) << 24 | 0xFFFFFF & 4);
                    this.sink.writeInt(n);
                    this.sink.flush();
                    return;
                }
            ...
            synchronized (this) {
                if (!this.closed) {
                    if (object.spdyRstCode != -1) {
                        this.sink.writeInt(0x80030000 | 0xFFFF & 3);
                        this.sink.writeInt((0 & 0xFF) << 24 | 0xFFFFFF & 8);
                        this.sink.writeInt(Integer.MAX_VALUE & n);
        ...
        void sendDataFrame(int n, int n2, Buffer object, int n3) throws IOException {
            if (!this.closed) {
                if ((long)n3 <= 0xFFFFFFL) {
                    ...
                    if (n3 > 0) {
                        this.sink.write((Buffer)object, (long)n3);
                    }
                    return;
                }
                object = new StringBuilder();
        ...
        public void settings(Settings object) throws IOException {
            synchronized (this) {
                ...
                if (!this.closed) {
                    ...
                    this.sink.writeInt(0x80030000 | 0xFFFF & 4);
                    this.sink.writeInt((0 & 0xFF) << 24 | n * 8 + 4 & 0xFFFFFF);
                    this.sink.writeInt(n);
                } else {
                    object = new IOException("closed");
                    throw object;
                ...
                for (n = 0; n <= 10; ++n) {
                    if (!((Settings)object).isSet(n)) continue;
                    int n2 = ((Settings)object).flags(n);
                    this.sink.writeInt((n2 & 0xFF) << 24 | n & 0xFFFFFF);
        ...
        public void synReply(boolean bl, int n, List<Header> object) throws IOException {
            synchronized (this) {
                ...
                this.sink.writeInt(0x80030000 | 0xFFFF & 2);
                this.sink.writeInt((n2 & 0xFF) << 24 | 0xFFFFFF & n3);
                this.sink.writeInt(Integer.MAX_VALUE & n);
                this.sink.writeAll(this.headerBlockBuffer);
                this.sink.flush();
        ...
        public void synStream(boolean bl, boolean bl2, int n, int n2, List<Header> object) throws IOException {
            synchronized (this) {
                ...
                int n4 = bl2 ? 2 : 0;
                this.sink.writeInt(0x80030000 | 0xFFFF & 1);
                this.sink.writeInt(((n4 | bl) & 0xFF) << 24 | 0xFFFFFF & n3);
                this.sink.writeInt(n & Integer.MAX_VALUE);
                this.sink.writeInt(Integer.MAX_VALUE & n2);
                this.sink.writeShort((0 & 7) << 13 | (0 & 0x1F) << 8 | 0 & 0xFF);
                this.sink.writeAll(this.headerBlockBuffer);
                this.sink.flush();
                return;
            }
        ...
        public void windowUpdate(int n, long l) throws IOException {
            synchronized (this) {
                ...
                if (l != 0L && l <= Integer.MAX_VALUE) {
                    this.sink.writeInt(0x80030000 | 0xFFFF & 9);
                    this.sink.writeInt((0 & 0xFF) << 24 | 0xFFFFFF & 8);
                    this.sink.writeInt(n);
