...
public final class HttpDate {
    ...
    public static Date parse(String string2) {
        ...
        synchronized (stringArray) {
            ...
            for (n = 0; n < n2; cloneable = ((DateFormat)cloneable).parse(string2, parsePosition), ++n) {
                dateFormatArray = BROWSER_COMPATIBLE_DATE_FORMATS;
            }
            {
                DateFormat dateFormat = dateFormatArray[n];
